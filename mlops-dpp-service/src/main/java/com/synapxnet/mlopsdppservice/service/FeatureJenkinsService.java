...
@Service
public class FeatureJenkinsService {

    private static final Logger logger = LoggerFactory.getLogger(FeatureJenkinsService.class);
    ...
    private void saveOrUpdateTaskInfo(String jobPath, JenkinsBuildStatus status) {
        try {
            ...
            taskInfo.setScheduleActive(0); // 立即执行
