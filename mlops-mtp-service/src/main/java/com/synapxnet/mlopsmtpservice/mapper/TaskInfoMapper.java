...
public interface TaskInfoMapper {
    @Insert("INSERT INTO xnet_mlops_mtp_train_info (" +
    ...
    @Update("UPDATE xnet_mlops_mtp_train_info SET " +
            "task_uid = #{task_uid}, " +
    ...
    @Select("SELECT job_uid, job_status, start_at, end_at, schedule_active " +
            "FROM xnet_mlops_mtp_train_info " +
    ...
    @Delete("DELETE FROM xnet_mlops_mtp_train_info WHERE job_uid = #{jobUid}")
